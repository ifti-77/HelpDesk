...
function AdminTickets() {
    const [viewWindow, setViewWindow] = React.useState<TicketStatus.OPEN | TicketStatus.IN_PROGRESS>(TicketStatus.OPEN)
    ...
    return (
        <div>
            ...
            {viewWindow === TicketStatus.OPEN && <div className="my-4 space-y-4 flex-1 rounded-lg bg-slate-100 p-4">
                {tickets?.map((ticket) => (
                    <div key={ticket.id}>
                        <h2>{ticket.title}</h2>
                    ...
                    <div className="w-full max-w-[90%] rounded-2xl bg-white p-6 shadow-2xl">
                        <div className="mb-5 flex flex-col items-start justify-between">
                            ...
                            <div className="flex flex-col items-start gap-2">
                                ...
                                {selectedTicket.assignedTo === null && <div>
...
function ReturnStatusStyle(status: TicketStatus) {
