...
export default function () {
    ...
    return (
        <div className=' flex justify-stretch items-center h-lvh bg-slate-200'>
            <form onSubmit={handleSubmit} className='bg-white p-8 w-full max-w-xl h-full flex flex-col justify-center'>
                <div className='my-4'><span className='font-mono font-bold text-xl text-gray-800'>HelpDesk: </span> 
                <span className='font-mono text-md text-indigo-800'>One Place solution for coorporate problems</span></div>
                ...
                <div className='mb-4'>
                    ...
                    <input className=' w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-green-200'
